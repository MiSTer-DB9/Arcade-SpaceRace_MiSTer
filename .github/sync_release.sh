...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-SpaceRace_MiSTer.git"
CORE_NAME=(Arcade-SpaceRace)
...
UPSTREAM_CORE_NAME=(Arcade-SpaceRace)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-SpaceRace.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-SpaceRace.rbf)
